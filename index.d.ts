declare module "thinky" {
  ...
  module connect {
    ...
    export interface Document<UDocument extends Document<any, any, any>, UModel extends Model<any, any, any>, UAttributes> {
      ...
      removeRelation<OtherUDocument extends Document<any, any, any>>(field: string, joinedDocument?: OtherUDocument): bluebird.Thenable<UDocument> | bluebird.Thenable<boolean>;//TODO: improve
    ...
    export interface ItemSequence<UDocument> extends Operation<UDocument>, Writeable {
      ...
      //thinky join
      getJoin(modelToGet?: { [key: string]: boolean }): ItemSequence<UDocument>;
    ...
    export interface Sequence<UDocument> extends Operation<UDocument[]>, Writeable {
      ...
      //thinky join
      getJoin<JoinedUDocument extends connect.Document<any, any, any>>(modelToGet?: { [key: string]: boolean }): Sequence<JoinedUDocument>;
